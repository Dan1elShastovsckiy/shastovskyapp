                      ...
                      children: [
                        ...
                        ListTile(
                          leading:
                              Icon(Icons.check_circle, color: Colors.green),
                          title: Text(
                              "Создание раздела 'Попробуй кодить' с интерактивными примерами кода"),
                          subtitle: Text(
                              "Реализовано. Добавлен раздел с песочницей html/css."),
                        ),
                        ListTile(
                  ...
                  children: [
                        ...
                        child: RichText(
                          ...
                          text: TextSpan(
                            ...
                            children: [
                              const TextSpan(
                                text:
                                    "Это приложение, являющееся для меня некой песочницей для изучения технологий, написанное на ",
                              ),
                              TextSpan(
                                text: "Flutter",
                              ...
                              const TextSpan(
                                text:
                                    ...
                                    "А также служит моим портфолио, блогом и приложением где я могу делиться полезным со своими подопечными. Здесь я делюсь результатами своей работы, пишу полезные статьи(кому-то надеюсь они окажутся полезными), а также своими путешествиями и фотографиями.",
                              ),
                            ],
                          ),
                        ),
                    ...
                    Align(
                      ...
                      child: Container(
                        margin: marginBottom24,
                        child: Text(
                            "Я его делаю чтобы: 1) Изучать и тестировать технологии в боевом режиме; 2) Показать свои навыки и возможности Dart/Flutter. А также, чтобы у меня была простая ссылка на все мое портфолио, в котором будет информация обо мне - как о специалисте, мои проекты и результаты моей работы, а также мой блог с фотографиями и историями путешествий, потому что мне это нравится и я хочу делиться своими впечатлениями и знаниями с окружающими.",
                            style: subtitleTextStyle(context),
                            textAlign: TextAlign.center),
                      ),
                    ),
                    ...
                    Align(
                      ...
                      child: Container(
                        margin: marginBottom24,
                        child: Text(
                            "Дальше у меня есть планы развивать это приложение, добавлять новые разделы и возможности. Например, я хочу разделить меню главная на меню блог и сделать два меню с Блогом и Полезными материалами(Уже сделал). На Полезные материалы повесить подменю SEO обучение и Разработка обучение. Дальше хочу добавить интерактивные курсы, где можно будет не только читать статьи, но и выполнять практические задания прямо в приложении. Также планирую добавить возможность комментирования статей, чтобы читатели могли делиться своими мыслями и задавать вопросы. В общем, много всего интересного впереди!",
                            style: subtitleTextStyle(context),
                            textAlign: TextAlign.center),
                      ),
                    ),
